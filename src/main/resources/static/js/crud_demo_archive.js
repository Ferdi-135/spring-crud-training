...
function getEverything(){
    // Make AJAX call to read-table endpoint
    $.ajax({
        url: "/read-table",
        type: "GET",
        dataType: "json",
        success: function(data) {
            // Iterate over the list of StudentEntity objects
            $.each(data, function(index, student) {
                // Create HTML elements to display each student's data dynamically
                var studentHtml = '<div class="table_line"> <p>';
                $.each(student, function(key, value) {
                    studentHtml += value + ' ';
                });
                studentHtml += '</p></div>';
                
                // Append the HTML for the student to the studentList container
